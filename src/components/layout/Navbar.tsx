  ...
  return (
    <nav className={`fixed top-0 z-50 w-full transition-all duration-300 ${scrolled ? 'bg-white shadow-md' : 'bg-white/95 border-b border-gray-100'}`}>
      <div className="mx-auto flex h-[80px] max-w-[1440px] items-center justify-between px-6 lg:px-10">
        ...
        {/* Logo Area */}
        <Link href="/" className="flex flex-col items-center justify-center relative z-10 group mt-2">
          <Image 
            src="/cresta-logo.png" 
            alt="Cresta Global Logo" 
            width={124} 
            height={112} 
            className="group-hover:scale-105 transition-transform duration-300 object-contain w-auto h-[70px]"
            priority
          />
        </Link>
        ...
        <div className="flex items-center gap-5 lg:gap-6 text-[#4b5563]">
          ...
          <button onClick={() => setIsMobileMenuOpen(true)} className="lg:hidden p-1 text-[#1F2937]">
        ...
        <div className="fixed inset-0 z-[200] flex items-center justify-center p-4">
          ...
          <div className="relative bg-white rounded-3xl p-8 max-w-sm w-full shadow-2xl border border-gray-100 flex flex-col items-center text-center animate-in fade-in zoom-in duration-200">
            <div className="w-14 h-14 bg-red-50 rounded-full flex items-center justify-center mb-5 border border-red-100">
              <LogOut className="size-6 text-red-500 ml-1" />
            </div>
        ...
        <div className="fixed inset-0 z-[200] flex items-center justify-center p-4">
          ...
          <div className="relative bg-white rounded-3xl p-8 max-w-sm w-full shadow-2xl border border-gray-100 flex flex-col items-center text-center animate-in fade-in zoom-in duration-200">
            ...
            <div className="w-16 h-16 bg-blue-50 rounded-full flex items-center justify-center mb-5 border border-blue-100">
              <MapPin className="size-7 text-[#2874f0]" />
            </div>
            ...
            <div className="w-full relative mb-4">
              <input 
                ...
                className="w-full px-4 py-3.5 bg-gray-50 border border-gray-200 rounded-xl text-center text-lg font-bold tracking-[0.2em] focus:outline-none focus:border-[#2874f0] focus:ring-1 focus:ring-[#2874f0] transition-all"
              />
            </div>
