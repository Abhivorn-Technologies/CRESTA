    ...
    <section className="w-full py-12 lg:py-16 bg-[#fdfdfd]">
      <div className="mx-auto max-w-[1440px] px-6 lg:px-10">
        ...
        <motion.div 
          ...
          className="relative w-full overflow-hidden rounded-[2.5rem] bg-[#101b4d] text-white shadow-2xl px-8 py-12 md:p-16 lg:p-20 flex flex-col justify-center min-h-[512px]"
        >
          {/* Background image placeholder / overlay */}
          <div className="absolute inset-0 opacity-40 mix-blend-overlay pointer-events-none">
            <Image src="/images/AB6AXuBm0DEBZy4ie0uQ.png" alt="Make Every Occasion Special" fill className="object-cover"  sizes="(max-width: 768px) 100vw, (max-width: 1200px) 50vw, 33vw" />
          ...
          <div className="relative z-20 flex flex-col max-w-xl gap-6">
