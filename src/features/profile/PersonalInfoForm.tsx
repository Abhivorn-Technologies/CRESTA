      ...
      <form onSubmit={handleSave} className="p-8 flex flex-col gap-10">
        ...
        <section className="flex flex-col gap-6">
          ...
          <div className="flex flex-col sm:flex-row gap-4 max-w-[550px]">
            <input 
              ...
              required
              className="flex-1 p-3 rounded border border-gray-300 bg-white focus:outline-none focus:border-[#e6127d] text-sm font-medium transition-colors"
        ...
        <div className="mt-4">
          <button 
            type="submit" 
            disabled={isSaving}
            className="px-10 py-3.5 bg-[#e6127d] text-white text-sm font-bold rounded shadow hover:bg-[#1a5bc3] transition-colors disabled:opacity-50"
          >
        ...
        <div className="fixed inset-0 z-[100] flex items-center justify-center bg-black/40 backdrop-blur-sm p-4">
          <div className="bg-white rounded-2xl p-6 max-w-sm w-full shadow-2xl relative z-[101] flex flex-col items-center text-center animate-in fade-in zoom-in-95 duration-200">
            ...
            <button 
              type="button"
              onClick={() => setShowSuccessModal(false)}
              className="w-full px-4 py-3 rounded-xl bg-[#e6127d] text-white font-bold text-sm hover:bg-[#1a5bc3] transition-colors flex items-center justify-center"
            >
              Done
            </button>
          </div>
