    ...
    <div className="w-full max-w-[1152px] mx-auto flex flex-col lg:flex-row gap-8 lg:gap-16 items-start">
      ...
      <div className="w-full lg:w-[544px] flex flex-col pt-2 lg:pt-0">
        ...
        <div className="flex gap-4 mb-10">
          ...
          {/* Quantity Selector */}
          <div className="flex items-center border border-gray-200 rounded shrink-0 h-12">
            <button onClick={handleDecrease} className="w-10 h-full flex items-center justify-center text-gray-500 hover:text-[#00113A] transition-colors">
              <Minus className="size-4" />
            </button>
            <div className="w-10 h-full flex items-center justify-center text-sm font-bold text-[#00113A]">
              {quantity}
            </div>
            <button onClick={handleIncrease} className="w-10 h-full flex items-center justify-center text-gray-500 hover:text-[#00113A] transition-colors">
          ...
          <button 
            ...
            className="flex-1 bg-[#00113A] hover:bg-[#1a2b7c] text-white h-12 rounded flex items-center justify-center gap-2 text-xs font-bold uppercase tracking-wider transition-colors shadow-sm"
          >
