...
import { PaymentContainer } from "@/features/checkout/PaymentContainer";
import { Check } from "lucide-react";
import Link from "next/link";

export default function PaymentPage() {
  return (
    <main className="flex min-h-screen flex-col relative overflow-hidden bg-[#f0f3fa]">

      <Navbar />
      
      <div className="flex-1 w-full max-w-[1152px] mx-auto px-6 pt-[120px] pb-24 relative z-10">
        ...
        <div className="flex flex-col items-center mb-16 relative">
          ...
          <div className="flex items-start justify-between w-full max-w-[500px] relative mt-4">
            ...
            <Link href="/checkout" className="flex flex-col items-center gap-2 relative z-10 w-24 group cursor-pointer hover:opacity-80 transition-opacity">
              <div className="w-8 h-8 rounded-full bg-[#00113A] text-white flex items-center justify-center text-sm shadow-sm ring-[6px] ring-[#f0f3fa] group-hover:scale-110 transition-transform">
                <Check className="size-4" strokeWidth={3} />
              </div>
              <span className="text-[10px] font-bold text-[#00113A] uppercase tracking-wider text-center group-hover:text-[#e6127d] transition-colors">Shipping</span>
            </Link>
            ...
            <div className="flex flex-col items-center gap-2 relative z-10 w-24">
              ...
              <span className="text-[10px] font-bold text-[#00113A] uppercase tracking-wider text-center">Payment</span>
            </div>
