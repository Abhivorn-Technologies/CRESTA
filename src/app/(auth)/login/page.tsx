...
export default function LoginPage() {
  ...
  return (
    ...
    >
      ...
      <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} className="flex justify-center mb-8 lg:hidden">
        <Image src="/cresta-logo.png" alt="Cresta" width={80} height={80} className="object-contain" />
      </motion.div>
      ...
      {/* Role Selector Tabs */}
      <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} className="flex bg-gray-50 p-1.5 rounded-xl mb-8 relative shadow-inner">
      ...
      <form onSubmit={handleSubmit} className="flex flex-col gap-5" autoComplete="off">
        <motion.div initial={{ opacity: 0, x: 10 }} animate={{ opacity: 1, x: 0 }} transition={{ delay: 0.1 }} className="flex flex-col gap-1.5 relative">
          ...
          <input 
            ...
            className="px-4 py-3 rounded-xl border border-gray-200 focus:outline-none focus:ring-[3px] focus:ring-[#e6127d]/20 focus:border-[#e6127d] transition-all bg-gray-50/50 hover:bg-white focus:bg-white text-[15px] shadow-sm autofill-fix"
        ...
        <motion.div initial={{ opacity: 0, x: 10 }} animate={{ opacity: 1, x: 0 }} transition={{ delay: 0.2 }} className="flex flex-col gap-1.5 relative">
          ...
          <div className="relative">
            <input 
              ...
              className="w-full px-4 py-3 rounded-xl border border-gray-200 focus:outline-none focus:ring-[3px] focus:ring-[#e6127d]/20 focus:border-[#e6127d] transition-all bg-gray-50/50 hover:bg-white focus:bg-white text-[15px] shadow-sm autofill-fix pr-12"
        ...
        <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 0.3 }} className="flex justify-end mt-[-8px] mb-2">
        ...
        <motion.button 
          ...
          type="submit" 
          disabled={isLoading} 
          className="w-full bg-[#e6127d] text-white hover:bg-[#101b4d] hover:-translate-y-0.5 rounded-xl py-3.5 text-[15px] font-bold transition-all duration-300 shadow-[0_8px_20px_-6px_rgba(230,18,125,0.5)] hover:shadow-xl disabled:opacity-70 flex items-center justify-center overflow-hidden relative group"
        >
      ...
      <motion.p initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 0.5 }} className="mt-8 text-center text-sm font-medium text-gray-500">
